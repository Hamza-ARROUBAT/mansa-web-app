...
export const CHANGE_CONTRIBUTION = 'CHANGE_CONTRIBUTION';
export const CHANGE_CONTRIBUTION_SUCCESS = typeCreator(CHANGE_CONTRIBUTION, successTag);
export const CHANGE_CONTRIBUTION_ERROR = typeCreator(CHANGE_CONTRIBUTION, errorTag);
